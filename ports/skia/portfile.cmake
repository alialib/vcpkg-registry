...
vcpkg_list(SET SKIA_TARGETS ":skia" "modules/skshaper:skshaper" "modules/skottie:skottie" "modules/skparagraph:skparagraph" "experimental/sktext:sktext" "experimental/skunicode:skunicode")
...
if (${VCPKG_DETECTED_CMAKE_CXX_COMPILER} MATCHES "cl.exe$")
    ...
    string(APPEND OPTIONS_DBG " extra_ldflags=${SKIA_DEBUG_LD_FLAGS}")
    string(APPEND OPTIONS_REL " extra_ldflags=${SKIA_RELEASE_LD_FLAGS}")
endif()
...
vcpkg_list(SET SKIA_DEFINITIONS_REL)
vcpkg_list(SET SKIA_DEP_REL)
if(NOT VCPKG_BUILD_TYPE)
    vcpkg_list(SET SKIA_DEFINITIONS_DBG)
...
cmake_print_variables(SKIA_DEFINITIONS_REL)
cmake_print_variables(SKIA_DEP_REL)
if(NOT VCPKG_BUILD_TYPE)
    cmake_print_variables(SKIA_DEFINITIONS_DBG)
    cmake_print_variables(SKIA_DEP_DBG)
endif()
